...
<div id="container">					
    ...
    <h1 class="text-center">Logos</h1>
      ...
      <div class="col-xs-12 col-md-4 text-center">
      	<a class="fancybox thumbnail" href="/resources/media/Logo1-bretonsmartek.jpg" alt="Breton SmarTek Logo">
      ...
      <div class="col-xs-12 col-md-4 text-center">
      	<a class="fancybox thumbnail" href="/resources/media/Logo2-fireq.jpg" alt="FireQ-RVS Logo">
          <img src="/resources/media/Logo2-fireq.jpg" class="wide center-block"/>
        </a>
      	<p class="text-center font-weight-bold">FireQ-RVS Logo</p>
      </div>
      <div class="col-xs-12 col-md-4 text-center">
      	<a class="fancybox thumbnail" href="/resources/media/Logo3-cit.png" alt="Customer In Touch Logo">
      ...
      <div class="col-xs-12 col-md-4 text-center">
      	<a class="fancybox thumbnail" href="/resources/media/Logo4-ggm.jpg" alt="Go Green Messaging Logo">
      ...
      <div class="col-xs-12 col-md-4 text-center">
      	<a class="fancybox thumbnail" href="/resources/media/businessCard.png" alt="Go Green Messaging Logo">
      ...
      <div class="col-xs-12 col-md-4 text-center">
      	<a class="fancybox fancybox thumbnail" href="/resources/media/musicFlyer1.jpg" alt="Go Green Messaging Logo">
      ...
      <div class="col-xs-12 col-md-4 text-center">
      	<a class="fancybox fancybox thumbnail" href="/resources/media/musicFlyer2.jpg" alt="Go Green Messaging Logo">
      ...
      <div class="col-xs-12 col-md-4 text-center">
      	<a class="fancybox fancybox thumbnail" href="/resources/media/musicFlyer3.jpg" alt="Go Green Messaging Logo">
