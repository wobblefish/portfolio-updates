asyncTest( "Popcorn Image Plugin", function() {
  ...
  var popped = Popcorn( "#video" ),
      ...
      sources = [
        "http://www.drumbeat.org/resources/drumbeat-logo-splash.png",
        "http://www.petmountain.com/category/mini/organic-dog-supplies/520/organic-dog-supplies.jpg",
        "http://www.botskool.com/sites/default/files/resources/javascript.png"
      ];
...
asyncTest( "Zerostart doesn't rehide", 1, function() {
  ...
  popped.on( "canplayall", function() {
    ...
    popped.image({
      ...
      src: "http://www.drumbeat.org/resources/drumbeat-logo-splash.png",
      target: "zerostart"
    });
